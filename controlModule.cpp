...
void addChangeRequestControl() {
    ...
    tempChangeItem = tempChangeItem.displayAndReturnChangeItem(tempProd, productFile);
...
void updateChangeItemControl() {
    ...
    tempProductPtr = &(tempProduct.displayProductFromFile(fileName));
    tempChangeItem = tempChangeItem.displayAndReturnChangeItem(*tempProductPtr, fileName);
    tempChangeItem.updateChangeItem(fileName,tempChangeItem);
}
...
void displayRemReportControl() {
    const char* fileName;
    changeItem tempChangeItem;
    tempChangeItem.displayRemainingReports();
}
...
void displayNotifyReportControl() {
    ...
    Product product;
    product.checkProductExists("products.bin", productID);
